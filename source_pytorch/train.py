...
if __name__ == '__main__':
    ...
    # Model Parameters
    parser.add_argument('--input_features', type=int, default=50, metavar='IN',
                        help='number of inputs to model (default: 50)')
    ...
    criterion = nn.BCELoss() # using the Binary Cross Entropy loss function
